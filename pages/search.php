...
<div style="max-width:700px;">
    <p style="margin-top:0px;">
        ...
        <button id="resetBtn" class="w3-button w3-pale-green w3-small w3-padding-small w3-margin-top">Sökhjälp</button>
    </p>
    <p>
        <span id="status"></span>
    </p>
    <p>
    <div id="results">
        <p>Det finns fyra olika sätt att söka. Vid varje sökning kommer alla fyra sökningssätt ske.
            Alla sökningar är skiftesokänsliga, 
...
<script>
    var Ask = {
        ...
        init: function () {
            this.search_help_html = this.el.results.innerHTML;
            ...
            document.getElementById("resetBtn").addEventListener("click", function (event) {
                event.preventDefault();
                Ask.el.results.innerHTML = Ask.search_help_html;
                return false;
            });
            Ask.search();
